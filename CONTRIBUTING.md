...
posted to #triton-dev on irc.freenode.net).
...
Copyright (c) 2017-2018 Triton Developers.
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to Triton code or Triton's dependency code or Triton's potential/future dependency code or research which successfully implements Triton.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Triton Maintainer Team.
