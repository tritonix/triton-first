...
ENTRYPOINT ["tritond", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=3060", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=3061", "--non-interactive", "--confirm-external-bind"]
